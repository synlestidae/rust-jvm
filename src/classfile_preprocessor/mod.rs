...
pub fn load_classfile_from_bytes(bytes: &[u8]) -> Result<RefinedClassFile, ClassFileProcessingError> {
...
pub fn load_classfile_from_file(path: &Path) -> Result<RefinedClassFile, ClassFileProcessingError> {
